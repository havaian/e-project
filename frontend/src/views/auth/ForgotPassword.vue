        ...
        <div class="max-w-md w-full space-y-8">
            <div v-if="!success">
                ...
                <div class="text-center mt-6">
                    <router-link to="/login" class="font-medium bg-gradient-to-r from-sky-500 to-cyan-500 bg-clip-text text-transparent hover:from-brand-1 hover:to-brand-2 transition-all">
                        ← Back to login
                    </router-link>
                </div>
            </div>
