    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white shadow rounded-lg overflow-hidden">
            ...
            <div class="p-4 border-b border-gray-200">
                <h1 class="text-lg font-medium text-gray-900">AI Educational Assistant</h1>
                <p class="mt-1 text-sm text-gray-500">
                    Ask general academic performance questions and get instant guidance
                </p>
            </div>
                    ...
                    <div v-for="message in messages" :key="message.id" class="flex mb-4"
                        ...
                        <div v-if="message.sender === 'assistant'" class="flex-shrink-0 mr-3">
                            <div class="h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center">
                                <svg class="h-6 w-6 bg-gradient-to-r from-sky-500 to-cyan-500 bg-clip-text text-transparent " fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
