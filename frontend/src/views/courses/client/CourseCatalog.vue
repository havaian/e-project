            ...
            <div class="flex flex-col sm:flex-row gap-3 mb-8">
                <div class="relative flex-1">
                    ...
                    <input v-model="searchInput" type="text" placeholder="Search courses…"
                        class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent bg-white"
                        @keyup.enter="doSearch" />
                </div>
                <input v-model="categoryInput" type="text" placeholder="Category…"
                    class="sm:w-48 border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent bg-white"
                    @keyup.enter="doSearch" />
