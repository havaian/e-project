...
export const isAchievementsEnabled = () => {
  return import.meta.env.VITE_MODULE_ACHIEVEMENTS_ENABLED !== 'false' // Default false
}

// Check if group consultations module is enabled
export const isGroupConsultationsEnabled = () => {
  return import.meta.env.VITE_MODULE_GROUP_CONSULTATIONS_ENABLED === 'false' // Default false
}

// Check if monthly payments module is enabled  
export const isMonthlyPaymentsEnabled = () => {
  return import.meta.env.VITE_MODULE_MONTHLY_PAYMENTS_ENABLED === 'false' // Default false
}
