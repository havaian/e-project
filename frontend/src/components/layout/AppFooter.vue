      ...
      <div class="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
        <div class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
          <p class="text-gray-400 text-sm">
            © {{ new Date().getFullYear() }} e-project.uz. All rights reserved.
          </p>
          <div class="flex space-x-6">
            <a href="#" class="text-gray-400 hover:text-educational-blue text-sm transition-colors duration-200">Privacy Policy</a>
            <a href="#" class="text-gray-400 hover:text-educational-blue text-sm transition-colors duration-200">Terms of Service</a>
            <a href="#" class="text-gray-400 hover:text-educational-blue text-sm transition-colors duration-200">FERPA Compliance</a>
          </div>
        </div>
        ...
        <div class="flex items-center space-x-4 mt-4 md:mt-0">
          <div class="flex items-center space-x-2 bg-gray-800 rounded-lg px-3 py-2">
            <svg class="w-4 h-4 text-educational-green" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
            </svg>
            <span class="text-xs text-gray-300">SSL Secured</span>
          </div>
          <div class="flex items-center space-x-2 bg-gray-800 rounded-lg px-3 py-2">
            <svg class="w-4 h-4 text-educational-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
