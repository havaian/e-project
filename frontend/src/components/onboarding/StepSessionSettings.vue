<template>
    <div class="space-y-8">
        ...
        <div class="space-y-6">
            ...
            <div v-if="modelValue.sessionFee && modelValue.sessionDuration"
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-black-900">Earnings Preview</h4>
        ...
        <div class="bg-blue-50 rounded-xl p-6 border border-blue-200">
            <div class="flex items-start space-x-3">
                <svg class="w-6 h-6 text-black-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
                <div>
                    <h4 class="font-semibold text-black-900 mb-3">Pricing Strategy Tips</h4>
                    <div class="space-y-2 text-sm text-black-700">
                        <div class="flex items-start space-x-2">
                            <span class="text-black-500 mt-0.5">•</span>
