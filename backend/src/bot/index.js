...
//                 "/start - Start the bot\n" +
//                 "/link - Link your dev.e-stud.uz account\n" +
...
//             await ctx.reply(
//                 "To link your dev.e-stud.uz account, I'll need your email address.\n\n" +
//                 "Please enter the email you used to register on dev.e-stud.uz:"
//             );
//         } catch (error) {
...
//                         await ctx.reply("❌ Email not found. Please make sure your email is registered with dev.e-stud.uz.");
...
//                 await ctx.reply(
//                     "You need to link your dev.e-stud.uz account first. Use /link to get started."
//                 );
//                 return;
//             }
...
//             if (!user) {
//                 await ctx.reply(
//                     "Your account is not linked. Use /link to connect your dev.e-stud.uz account."
//                 );
//                 return;
//             }
...
//             await ctx.reply(
//                 "⚠️ Are you sure you want to unlink your dev.e-stud.uz account? You will no longer receive notifications.\n\n" +
...
//             await ctx.reply(
//                 "👨‍⚕️ I'm the dev.e-stud.uz virtual educational assistant. I can answer general educational questions and provide academic performance information.\n\n" +
...
//                 if (!user) {
//                     await ctx.reply("Your account is not linked to dev.e-stud.uz.");
//                     ctx.session.step = 'idle';
//                     return;
//                 }
...
//                 await ctx.reply(
//                     "✅ Your dev.e-stud.uz account has been unlinked successfully.\n\n" +
...
//             }
//         } else if (answer === 'no' || answer === 'n') {
//             await ctx.reply("Account unlinking canceled. Your account remains linked to dev.e-stud.uz.");
//         } else {
//             await ctx.reply("Please answer with Yes or No.");
